...
void cpu_gpu::motionHandle() {
  if (((enterPressed && objIndex == REMOVE_GPU) || objMove == true) &&
      !assemble) {
    objMove = true;
    move.x -= 0.007;
  ...
  } else if (((enterPressed && objIndex == REMOVE_GPU) || objMove == true) &&
             assemble) {
    objMove = true;
    visible = true;
...
void cpu_gpu::render() {
  ...
  glBegin(GL_POLYGON);
  glTexCoord2f(0., 0.);
  glVertex3f(-1.75, 0, 0.2);
  glTexCoord2f(1., 0);
  glVertex3f(1.5, 0, 0.2);
  glTexCoord2f(1, 1);
  glVertex3f(1.5, 1.5, 0.2);
  glTexCoord2f(0., 1);
  glVertex3f(-1.75, 1.5, 0.2);
  glEnd();
  ...
  glTexCoord2f(0., 0.);
  glVertex3f(-1.75, 0, 0.0);
  glTexCoord2f(1., 0.);
  glVertex3f(-1.75, 1.5, 0.0);
  glTexCoord2f(1., 1.);
  glVertex3f(-1.75, 1.5, 0.3);
  glTexCoord2f(0., 1.);
  glVertex3f(-1.75, 0, 0.3);
  glEnd();
