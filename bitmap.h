...
void front_page() {
  ...
  renderBitmapString(-1.2f, 3.0f, -0.1f, (void *)helv18,
                     (char *)"RV College Of Engineering");
  renderBitmapString(-1.35f, 2.6f, -0.1f, (void *)helv18,
                     (char *)"Computer Science Department");
  renderBitmapString(-0.6f, 2.3f, -0.1f, (void *)helv12,
                     (char *)"A MINI PROJECT ON");
  renderBitmapString(
      -2.85f, 2.0f, -0.1f, (void *)helv18,
      (char *)"GRAPHICAL SIMULATION OF DESKTOP AND ITS COMPONENTS");

  renderBitmapString(-1.5f, 1.5f, -0.1f, (void *)times10, (char *)"BY:");
  renderBitmapString(-2.4f, 1.3f, -0.1f, (void *)helv12,
                     (char *)"VIBHAV SIMHA");
  renderBitmapString(-2.4f, 1.1f, -0.1f, (void *)helv12, (char *)"AARYAN P");
  renderBitmapString(-2.4f, 0.9f, -0.1f, (void *)helv12,
...
void progress_wheel(void) {
  ...
  glColor3f(1.0, 1.0, 1.0);
  renderBitmapString(-0.68f, -0.4f, -0.2f, (void *)helv12,
